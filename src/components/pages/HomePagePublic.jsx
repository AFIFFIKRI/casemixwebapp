            ...
            <Row>
              ...
              <Col className="mb-3">
                <Card
                  ...
                  id="card3"
                  onClick={() =>
                    navigate("/dashboardpublic/hospital-list", { state: { initialStep: 3 } })
                  }
                  style={{ cursor: "pointer" }}
                >
                  <Card.Body>
                    <IconContext.Provider
                      value={{ color: "#364DB9", size: "40" }}
                    >
                      <Col>
                        <IoBookOutline />
                      </Col>
                    ...
                    <Col>
                      <p style={{ fontSize: "10px", lineHeight: "1.2" }}>
                        *Assign DRG Code based on diagnosis and procedures
                        selected
                      </p>
                    </Col>
                  </Card.Body>

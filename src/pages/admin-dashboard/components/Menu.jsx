    ...
    <>
      ...
      <Offcanvas show={show} onHide={handleClose} placement="start" style={{ width: '70%' }}>
        ...
        <Offcanvas.Body>
          ...
          <div onClick={() => handlePageClick('patient')} style={getMenuItemStyle('patient')}>
            Patient
          </div>
          <div onClick={() => handlePageClick('doctor')} style={getMenuItemStyle('doctor')}>
            Doctor
          </div>
          <div onClick={() => handlePageClick('analytic')} style={getMenuItemStyle('analytic')}>
            Analytic
          </div>
          <div onClick={() => handlePageClick('invoice')} style={getMenuItemStyle('invoice')}>
            Invoice
          </div>
          <div onClick={() => handlePageClick('report')} style={getMenuItemStyle('report')}>
            Report
          </div>
        </Offcanvas.Body>
      </Offcanvas>

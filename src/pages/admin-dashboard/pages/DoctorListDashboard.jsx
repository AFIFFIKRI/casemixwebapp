        ...
        <Col>
            <StyledCard className='mb-4'>
                <Card.Body>
                    <Row>
                        <Col md={6}>
                            <Typography variant="h5" style={{fontWeight: 'bold'}}>Doctor List</Typography>
                            <Typography style={{fontSize: 14}}>Doctor Records Management</Typography>
                        </Col>
            ...
            <StyledCard className='mb-4'>
                <Card.Body>
                    <Row style={{padding: 10,}}>
                        <Col md={8} sm={12}>
                            <Typography style={{fontWeight: 'bold'}}>All Doctor List</Typography>
                        </Col>
                        <Col md={4} sm={12}>
                            <TextField
                            id="search-input"
